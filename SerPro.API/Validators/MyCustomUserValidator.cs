...
namespace SerPro.API.Validators
{
    public class MyCustomUserValidator : UserValidator<UserMaster>
    {
        ...
        public override async Task<IdentityResult> ValidateAsync(UserMaster user)
        {
